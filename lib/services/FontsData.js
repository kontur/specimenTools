define([
  ...
  , languageCharSetsJson
    ...
    _p._getFullName = function (fontIndex) {
        ...
        if (typeof this._options.overwrites === "object" && 
            typeof this._options.overwrites[fileName] === "object" &&
            typeof this._options.overwrites[fileName].transforms === "object" &&
            typeof this._options.overwrites[fileName].transforms._getFullName === "function") {
            fullName = this._options.overwrites[fileName].transforms._getFullName(fullName);
        }
    ...
    // Truncate the family name to single word for more resilient browser rendering
    // TODO Possibly perform further transformation for the CSS name
    _p._getCSSFamilyName = function (fontIndex) {
        return this._getFamilyName(fontIndex).replace(/\s/gi, "");
    }
